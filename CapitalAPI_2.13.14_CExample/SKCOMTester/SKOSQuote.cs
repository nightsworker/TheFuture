    ...
    public partial class SKOSQuote : UserControl
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (m_bfirst == true)
            {
                ...
                m_SKOSQuoteLib.OnNotifyBest10 += new _ISKOSQuoteLibEvents_OnNotifyBest10EventHandler(this.OnNotifyBest10);
                m_bfirst = false;
            }
        ...
        void OnNotifyBest10(short sStockIdx, int nBestBid1, int nBestBidQty1, int nBestBid2, int nBestBidQty2, int nBestBid3, int nBestBidQty3,
