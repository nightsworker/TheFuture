...
namespace SKCOMTester
{
    public partial class SKQuote : UserControl
    {
        ...
        public Action<short, short> m_SKQuoteLib_OnNotifyQuote;
        ...
        public Action<short, short, int, int, int, int, int, int, int, int, int> m_SKQuoteLib_OnNotifyTicks;// (short sMarketNo, short sStockIdx, int nPtr, int nDate, int lTimehms, int lTimemillismicros, int nBid, int nAsk, int nClose, int nQty, int nSimulate);
        /*{
        ...
        public Action<short, short, short, int> m_SKQuoteLib_OnNotifyServerTime;
