...
namespace SKCOMTester
{
    public partial class SKOrder : UserControl
    {
        ...
        public void SetFutureAuto(SKCOMLib.SKQuoteLib skQuote)
        {
            futureOrderControl1.SKQuoteLib = skQuote;
            m_SKQuoteLib_OnNotifyTicks = futureOrderControl1.SKQuoteLib_OnNotifyTicks;
            m_SKQuoteLib_OnNotifyQuote = futureOrderControl1.m_SKQuoteLib_OnNotifyQuote;
            m_SKQuoteLib_OnNotifyServerTime = futureOrderControl1.m_SKQuoteLib_OnNotifyServerTime;
;
        }
