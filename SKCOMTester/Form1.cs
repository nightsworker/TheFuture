...
namespace SKCOMTester
{
    public partial class Form1 : Form
    {
        ...
        private void SetQuoteAuto()
        {
            skOrder1.SetFutureAuto(skQuote1.SKQuoteLib);
            skQuote1.m_SKQuoteLib_OnNotifyTicks = SKQuoteLib_OnNotifyTicks;
            skQuote1.m_SKQuoteLib_OnNotifyQuote = SKQuoteLib_OnNotifyQuote;
            skQuote1.m_SKQuoteLib_OnNotifyServerTime = SKQuoteLib_OnNotifyServerTime;
        ...
        {
            skQuote1.SKQuoteLib_OnNotifyTicks(sMarketNo, sStockIdx, nPtr, nDate, lTimehms, lTimemillismicros, nBid, nAsk, nClose, nQty, nSimulate);
            skOrder1.m_SKQuoteLib_OnNotifyTicks(sMarketNo, sStockIdx, nPtr, nDate, lTimehms, lTimemillismicros, nBid, nAsk, nClose, nQty, nSimulate);
            // m_pSKOrder.
        }

        public void SKQuoteLib_OnNotifyQuote(short sMarketNo, short sStockIdx)
        {
            skQuote1.SKQuoteLib_OnNotifyQuote(sMarketNo, sStockIdx);//, nPtr, nDate, lTimehms, lTimemillismicros, nBid, nAsk, nClose, nQty, nSimulate);
            skOrder1.m_SKQuoteLib_OnNotifyQuote(sMarketNo, sStockIdx);
        }

        public void SKQuoteLib_OnNotifyServerTime(short sHour, short sMinute, short sSecond, int nTotal)
        {
            skQuote1.SKQuoteLib_OnNotifyServerTime(sHour, sMinute, sSecond, nTotal);//, nPtr, nDate, lTimehms, lTimemillismicros, nBid, nAsk, nClose, nQty, nSimulate);
            skOrder1.m_SKQuoteLib_OnNotifyServerTime(sHour, sMinute, sSecond, nTotal);
        }
